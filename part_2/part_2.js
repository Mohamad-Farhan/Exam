...
SELECT meraki FROM INFORMATION_SCEHEMA 

Q6) What is the query for displaying the columns of a table called `users`?

SHOW COMLIMS FROM users IN meraki
...
UPDATE user SET name = info@meraki-academy WHERE condion;

Q9) What is the query to delete a user that has `info@meraki-academy.org` as an email?

DELETE FROM user WHERE email = info@meraki-academy.org
